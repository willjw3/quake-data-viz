...
export const QuakeDataHourly = async () => {
    ...
    const quakes = await data.features.filter((feature: any) => {
        if (feature.geometry.coordinates[0] > -176.7417 && feature.geometry.coordinates[0] < -66.9470 && feature.geometry.coordinates[1] > 22.0000 && feature.geometry.coordinates[1] < 71.3888) {
            return feature
        }
        return null;
    })
